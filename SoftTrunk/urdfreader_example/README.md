This is basically a copy of RBDL's sample code for reading URDFs into a model and doing forward dynamics on it. The original can be found under /examples/urdfreader in the source code.
